...
public class ClienteController {
	...
	@GetMapping(path = "api/cliente/{cliente}")
	public ResponseEntity<ClienteModel> getCliente(@PathVariable("cliente") Long cliente) {
		return clienteRepository.findById(cliente).map(record -> ResponseEntity.ok().body(record))
	...
	// atualiza um cliente do DB baseado em seu ID
